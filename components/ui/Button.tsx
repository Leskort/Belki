...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'horror' | 'ghost'
  size?: 'sm' | 'md' | 'lg'
  children: ReactNode
}
...
export function Button({
  ...
  const variants = {
    ...
    outline: 'border border-horror-glow/50 text-horror-glow hover:bg-horror-glow/10 hover:border-horror-glow',
    ...
    ghost: 'text-gray-300 hover:text-horror-glow hover:bg-horror-dark/30',
  }
